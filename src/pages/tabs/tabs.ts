...
export class TabsPage {
    ...
    constructor(public navCtrl: NavController, public navParams: NavParams, private alertCtrl: AlertController, public globalSer: ServicesProvider, public popoverCtrl: PopoverController, public toastCtrl: ToastController, public loader: LoadingController, public fb: Facebook, public events: Events, public db: LocalDbProvider, public sync: SyncProvider) {
    }
    ...
    notify(){
        this.navCtrl.push("NotificationscreenPage")
    }
    ...
    tabClick(ev:any){
        this.events.publish('tabClicked');     
    }
