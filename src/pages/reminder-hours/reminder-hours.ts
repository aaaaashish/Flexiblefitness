...
@IonicPage()
@Component({
    selector: 'page-reminder-hours',
    templateUrl: 'reminder-hours.html',
})
export class ReminderHoursPage {
    currInd = 0;
    wObj:any;
    bObj:any;
    loading:any;
    ...
    ionViewDidLoad() {
        console.log('ionViewDidLoad ReminderHoursPage');
    }
    ...
    submitFunc(){
        this.globalSer.userData.remHrsValue = this.user.hrValue;
